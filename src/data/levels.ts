...
export const levels: Level[] = [
  ...
  {
    id: 6,
    title: 'Sell Your Automations',
    subtitle: 'From skill to income — land your first paying client',
    icon: 'Briefcase',
    color: 'accent',
    duration: '3 weeks',
    lessonCount: 12,
    badge: { id: 'automation_seller', name: 'Automation Seller', icon: 'Briefcase' },
    modules: [
      { id: '6.1', title: 'The Freelance Automation Mindset', description: 'Position yourself as a consultant who solves business problems', xp: 50 },
      { id: '6.2', title: 'Choose Your Niche', description: 'Find the industries that pay well for automation work', xp: 50 },
      { id: '6.3', title: 'Build a Portfolio Without Clients', description: 'Create proof of your skills before your first paid deal', xp: 50 },
      { id: '6.4', title: 'Where to Find Clients', description: 'The 5 channels where automation buyers hang out', xp: 50 },
      { id: '6.5', title: 'Cold Outreach That Gets Replies', description: 'Scripts and sequences that turn strangers into leads', xp: 50 },
      { id: '6.6', title: 'The Discovery Call', description: 'Qualify leads and uncover the pain worth solving', xp: 50 },
      { id: '6.7', title: 'Pricing & Writing Your Proposal', description: 'Package your automation and name your price confidently', xp: 50 },
      { id: '6.8', title: 'Closing the Deal', description: 'Handle objections and get the signed agreement', xp: 50 },
      { id: '6.9', title: 'Contracts & Getting Paid', description: 'Protect yourself legally and ensure on-time payment', xp: 50 },
      { id: '6.10', title: 'Deliver Like a Pro', description: 'Project management, communication, and handover', xp: 50 },
      { id: '6.11', title: 'Upsells & Retainers', description: 'Turn one-off projects into recurring monthly income', xp: 50 },
      { id: '6.12', title: 'Milestone: Land Your First Client', description: 'Apply every skill to close a real or simulated deal', xp: 300, isMilestone: true },
    ],
  },
];
