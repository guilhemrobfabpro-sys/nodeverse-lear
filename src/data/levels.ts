...
export const levels: Level[] = [
  {
    ...
    duration: '2 weeks',
    lessonCount: 8,
    badge: { id: 'first_steps', name: 'First Steps', icon: '🌱' },
    modules: [
  ...
  },
  {
    ...
    duration: '3 weeks',
    lessonCount: 12,
    badge: { id: 'node_ninja', name: 'Node Ninja', icon: '⚡' },
    modules: [
  ...
  },
  {
    ...
    duration: '3 weeks',
    lessonCount: 10,
    badge: { id: 'ai_whisperer', name: 'AI Whisperer', icon: '🤖' },
    modules: [
  ...
  },
  {
    ...
    duration: '4 weeks',
    lessonCount: 12,
    badge: { id: 'system_architect', name: 'System Architect', icon: '🏗️' },
    modules: [
  ...
  },
  {
    ...
    duration: '4 weeks',
    lessonCount: 10,
    badge: { id: 'automation_master', name: 'Automation Master', icon: '🚀' },
    modules: [
